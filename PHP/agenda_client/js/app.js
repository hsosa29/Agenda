...
class EventsManager {
    ...
    obtenerDataInicial() {
        let url = '../agenda_server/getEvents.php'
        $.ajax({
          url: url,
          dataType: "json",
          cache: false,
    ...
    poblarCalendario(eventos) {
      ...
      if(this.validarForm() == true){;
        ...
        $.ajax({
          url: '../agenda_server/new_event.php',
          dataType: "json",
          cache: false,
          processData: false,
          contentType: false,
    ...
    eliminarEvento(event, jsEvent){
      ...
      $.ajax({
        url: '../agenda_server/delete_event.php',
        dataType: "json",
        cache: false,
        processData: false,
        contentType: false,
    ...
    actualizarEvento(evento) {
        ...
        $.ajax({
          url: '../agenda_server/update_event.php',
          dataType: "json",
          cache: false,
          processData: false,
          contentType: false,
